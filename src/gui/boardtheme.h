...
class BoardTheme : public QObject
{
    Q_OBJECT
public:
    enum ColorRole {LightSquare, DarkSquare, Highlight, Frame, CurrentMove, StoredMove, VariationMove, Threat, Target, Check, Wall, UnderProtected, Engine, ColorRoleEndEntry};
