...
Toga II 1.2.1 based on Fruit 2.1 by Fabien Letouzey.
...
Toga II 1.2.1 based on Fruit is a UCI-only chess engine.  This distribution comes up only with
...
A big thank to Dieter Eberle for his E26 setting.
