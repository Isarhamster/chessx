...
QMap<quint64, QString> ecoPositions;
QMap<quint64, QList<Square> > gtmPositions;
...
int main()
{
	...
	if (!parseAsciiEcoData("chessx.eco.txt"))
		qFatal("Could not read 'chessx.eco.txt' file, nothing compiled");
	...
	// Read the main ECO file back in as a test
