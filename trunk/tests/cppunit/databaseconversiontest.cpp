...
CPPUNIT_TEST_SUITE_REGISTRATION( DatabaseConversionTest );

void DatabaseConversionTest::setUp()
{
...
void DatabaseConversionTest::tearDown()
{
  // not used
}
...
void DatabaseConversionTest::testConvertDatabase()
{
  ...
  CPPUNIT_ASSERT( converter.playerDatabaseFromScidRatings( source, db_name, picture_dir ) );
}
