...
void IndexItemTest::testIndexItemCompleteTest() 
{
   ...
   val = item->index(0,2); QCOMPARE ( val , 0x45);
   val = item->index(2,2); QCOMPARE ( val , 0x0474);
   val = item->index(4,4); QCOMPARE ( val , 0x31323334);
   val = item->index(8,3); QCOMPARE ( val , 0x414243);
   val = item->index(11,2); QCOMPARE ( val , 0x6666);

   item->set(2,2,0x49);
   item->set(8,3,0x444546);
   val = item->index(0,2); QCOMPARE ( val , 0x45);
   val = item->index(2,2); QCOMPARE ( val , 0x49);
   val = item->index(4,4); QCOMPARE ( val , 0x31323334);
   val = item->index(8,3); QCOMPARE ( val , 0x444546);
   val = item->index(11,2); QCOMPARE ( val , 0x6666);

   item->allocate(40,false);
   item->set(38,2,0x7777);
   val = item->index(38,2); QCOMPARE ( val , 0x7777);
   val = item->set(39,2,0x3333); QCOMPARE ( val , -1);
   val = item->index(0,2); QCOMPARE ( val , 0x45);
   val = item->index(2,2); QCOMPARE ( val , 0x49);
   val = item->index(4,4); QCOMPARE ( val , 0x31323334);
   val = item->index(8,3); QCOMPARE ( val , 0x444546);
